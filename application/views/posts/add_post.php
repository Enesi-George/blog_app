...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('public/blog_page2/style.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('public/blog_page2/prospects.css'); ?>">
</head>
...
<body>
            ...
            <section class="content">
                <div class="wrapper">
                    ...
                    <div class="container2">
                        ...
                        <form class="blogForm2" action="<?php echo base_url('posts/store'); ?>" method="POST" enctype="multipart/form-data">
                            <!-- Add CSRF token -->
                            ...
                            <?php if ($this->session->flashdata('success')): ?>
                                <div class="alert alert-success" style="background-color: #d4edda; border: 1px solid #c3e6cb; color: #155724; padding: 10px; margin-bottom: 15px; border-radius: 4px;">
                                    <?php echo $this->session->flashdata('success'); ?>
                                </div>
                            <?php endif; ?>

                            <div class="formGroup2">
                                <label for="title" class="formLabel2">Post Title</label>
                                <!-- <input type="text" id="postTitle2" class="inputBox2" placeholder="search post title"> -->
                                <input type="text" name="title" id="title" class="inputBox2" placeholder="Title" required>
                            ...
                            <div class="formGroup2">
                                <label for="content" class="formLabel2">Post Description</label>
                                <!-- <textarea id="postContent2" class="textareaBox2" placeholder="description"></textarea> -->
                                <textarea name="content" id="content" class="textareaBox2" placeholder="Description" required></textarea>
                            ...
                            <div class="formGroup2">
                                ...
                                <div id="imagePreviewContainer" style="display: none; margin-bottom: 10px;">
                                    <img id="imagePreview" style="max-width: 200px; max-height: 200px; border: 1px solid #ddd; border-radius: 4px;">
                                    <div id="fileName" style="margin-top: 8px; font-size: 14px; color: black; word-break: break-all;"></div>
                                    <button type="button" id="removeImage" style="display: block; margin-top: 5px; padding: 5px 10px; background: #dc3545; color: white; border: none; border-radius: 4px; cursor: pointer;">Remove Image</button>
                                </div>
                                <input type="file" name="featured_image" id="imageUpload" class="uploadBtn2" accept="image/*" style="display: block;">
                            </div>
    ...
    <script src="<?php echo base_url('public/blog_page2/script.js'); ?>"></script>
    <script src="<?php echo base_url('public/blog_page2/image_preview.js'); ?>"></script>
